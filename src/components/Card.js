...
function Card(props) {
  return (
    <div
      className=" justify-content-center  j-card row mr-0   "
      onClick={(e) => props.click(props.item)}
    >
      <div className="j-card-img pt-0  ">
        <img
          className="j-card-image-left"
          src={props.item.imgSrcLeft}
          alt={props.item.imgSrcLeft}
        />
        <img
        ...
        <img
          ...
          src={props.item.imgSrcRight}
          alt={props.item.imgSrcRight}
        />
      </div>
