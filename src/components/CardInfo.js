        ...
        <div className=" d-flex justify-content-center flex-column j-card-info text-wrap "  >
           <div className="mt-5" >
            ...
            <div className="d-flex mt-auto h-25"  >
                <a className=" flex-fill" href={props.playstoreLink} target="_blank" rel="noopener noreferrer"><p className="link-color link">Play Store</p></a>
                <a className=" flex-fill" href={props.githubLink} target="_blank" rel="noopener noreferrer"><p className="link-color link">Github</p></a>
            </div>
        </div>
